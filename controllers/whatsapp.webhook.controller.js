...
const { handleWhatsappWebhookDocument } = require('../services/document.service');
...
exports.acceptMessage = (req, res) => {
    ...
    if (body.entry[0].changes[0].value.messages && body.entry[0].changes[0].value.messages.length > 0) {
